...
const find_product_dto_1 = require("../product/dto/find-product.dto");
const top_page_model_1 = require("./top-page.model");
const top_page_module_1 = require("./top-page.module");
...
__decorate([
    ...
    __metadata("design:paramtypes", [top_page_model_1.TopPage]),
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, top_page_module_1.TopPageModule]),
    __metadata("design:returntype", Promise)
], TopPageController.prototype, "update", null);
__decorate([
